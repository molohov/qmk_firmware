...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NAV] = LAYOUT(
    VS_EDIT,    VIM_LIND,   VS_COMT,    VIM_RIND,   KC_HOME,                            BY_FSWL,    BY_FSWR,    _______,    _______,    BY_KSRV,
    VS_TERM,    KC_LEFT,    KC_UP,      KC_RGHT,    SHIFTV,                             BY_RNWN,    BY_NWIN,    MD_TODO,    GRVS,       CW_TOGG,
    VS_EGRP,    PC_LWRD,    KC_DOWN,    PC_RWRD,    KC_END,                             _______,    BY_HSPL,    WINRUN,     MD_CODE,    PY_IPDB,
