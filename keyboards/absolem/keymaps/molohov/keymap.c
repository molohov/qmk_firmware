...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NAV] = LAYOUT(
    VS_EDIT,    VIM_LIND,   VS_COMT,    VIM_RIND,   _______,                            BY_FSWL,    BY_FSWR,    VIMQUIT,    MD_TODO,    QK_BOOT,
    VS_TERM,    KC_LEFT,    KC_UP,      KC_RGHT,    SHIFTV,                             BY_RNWN,    BY_NWIN,    VIMWRITE,   GRVS,       CW_TOGG,
    KC_HOME,    PC_LWRD,    KC_DOWN,    PC_RWRD,    KC_END,                             BY_KSRV,    BY_HSPL,    VIMWRITEQUIT, MD_CODE,  PY_IPDB,
