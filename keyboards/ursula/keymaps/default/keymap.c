...
[_QWERTY] = LAYOUT(
  ...
  KC_F2,  KC_Q,   KC_W,    KC_E,    KC_R,    KC_T,                          KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    RGB_TOG,
  KC_F3,  KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                          KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, RGB_RMOD,
  KC_F4,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,    KC_F9,       KC_F10,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, RGB_MOD,
