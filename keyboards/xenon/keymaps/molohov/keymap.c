...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_HOME,    KC_W,       KC_C,       KC_L,       KC_D,       KC_V,                               KC_MINS,    KC_U,       KC_O,       KC_Y,       KC_K,       KC_END,
                            KC_MPLY,    KC_ESC,     GUIDEL,     BSPNAV,     OS_SFT,     ENTBYO,     SPCNUM,     KC_ESC,     ON_TODO,    PC_LOCK,
                                        WINRUN,     PC_SCSH,    CAPSWD,     TABNUM,     KC_UNDS,    VS_COMT,    VS_CTLP,    PY_IPDB
    ),
    ...
    [_NAV] = LAYOUT(
    _______,    KC_SLSH,    KC_QUES,    SW_WIN,     SLKFPS,      VIM_RSP,                           _______,    OS_CTL,     OS_ALT,     OS_GUI,     OS_SFT,     _______,
    PC_SALL,    OS_GUI,     OS_ALT,     OS_SFT,     OS_CTL,      VIM_FSP,                           VS_EDIT,    KC_LEFT,    KC_UP,      KC_RGHT,    VS_TERM,    _______,
    PC_EXIT,    PC_UNDO,    PC_CUT,     PC_COPY,    PC_PASTE,    PC_CLIP,                           VS_EGRP,    VS_PEDT,    KC_DOWN,    VS_NEDT,    _______,    _______,
                            _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,
                                        _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______
    ),
    [_NUMPAD] = LAYOUT(
